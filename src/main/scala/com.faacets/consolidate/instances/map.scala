...
trait MapInstances {
  ...
  implicit def mapMerge[V:Merge]: Merge[Map[String, V]] = new Merge[Map[String, V]] {
  ...
  implicit def listMapMerge[V:Merge]: Merge[ListMap[String, V]] = new Merge[ListMap[String, V]] {
